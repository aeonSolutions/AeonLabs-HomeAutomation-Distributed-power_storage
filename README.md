...
For assembly with 79x38mm solar cells and up to 6x independent power solar lines with up to 97.1 % of efficiency that can be configured by a switch for 3 different DC outputs: 5V, 9V, and 12V ( 9A max).
